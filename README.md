...
- [Curso Básico de Python](#curso-básico-de-python)
  ...
  - [Modulo 5 Estructuras de datos](#modulo-5-estructuras-de-datos)
    ...
    - [Leer archivo de texto](#leer-archivo-de-texto-txt)
...
with open("./text.txt") as file:
  print(file.read())
```
- para leer archivos txt desde la pc o laptop que esta en la carpeta download
```py
with open("C:\\Users\\jonat\\Downloads\\hola.txt") as file:
  print(file.read())
```
- otra forma
```py
    ...
    file.close()
```
- Leer archivo txt en google colab
- ojo: Primero subir el archivo a fdrive
```py
   from google.colab import drive
    drive.mount('/content/drive')

    with open('/content/drive/My Drive/data/nombre_del_archivo.txt') as archivo:
    contenido = archivo.read()
```

### leer archivo csv o exel
```py
   import csv
   def read_csv(path):
